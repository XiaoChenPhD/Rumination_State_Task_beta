...
expName = 'rumination_demo'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ChenXiao/Library/CloudStorage/OneDrive-Personal/Documents/TMS_EEG_project/RST_alpha/rumination_demo_lastrun.py',
