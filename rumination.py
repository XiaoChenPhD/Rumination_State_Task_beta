...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ChenXiao/Library/CloudStorage/OneDrive-Personal/Documents/TMS_EEG_project/RST_alpha/rumination.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRumination_loop in rumination_loop:
        ...
        while continueRoutine and routineTimer.getTime() < 4.0:
            ...
            if prompt_constant.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > prompt_constant.tStartRefresh + 4-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if prompts.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > prompts.tStartRefresh + 4-frameTolerance:
                    # keep track of stop time/frame for later
