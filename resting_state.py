...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ChenXiao/Library/CloudStorage/OneDrive-Personal/Documents/TMS_EEG_project/RST_alpha/resting_state.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if key_resp_goodbye.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_goodbye.getKeys(keyList=['1','2','3'], ignoreKeys=["escape"], waitRelease=False)
